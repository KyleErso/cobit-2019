    ...
    <div class="col-md-10">
      <div class="card shadow border-0 rounded">
        ...
        <div class="card-header bg-primary text-white text-center py-3">
          <h4 class="mb-0">Design Factor 9</h4>
        </div>
        <!-- Card Body -->
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <tr>
                    <td>Agile</td>
                    <td>
                      <input type="number" name="input1df9" id="input1df9" class="form-control input-percentage" required>
                  ...
                  <tr>
                    <td>DevOps</td>
                    <td>
                      <input type="number" name="input2df9" id="input2df9" class="form-control input-percentage" required>
                      <small class="text-muted">Masukkan nilai dalam persen (contoh: 33 untuk 33%).</small>
                    </td>
                    <td class="text-center fw-bold text-success fs-5">
                      10%
                  ...
                  <tr>
                    <td>Traditional</td>
                    <td>
                      <input type="number" name="input3df9" id="input3df9" class="form-control input-percentage" required>
