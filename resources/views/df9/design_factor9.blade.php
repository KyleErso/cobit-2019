            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('df9.store') }}" method="POST" onsubmit="return validateForm()">
                        ...
                        <!-- 3 Input Fields for df9 -->
                        <div class="form-group">
                            <label for="input1df9">High</label>
                            <input type="number" name="input1df9" id="input1df9" class="form-control" required>
                            <small class="text-muted">Masukkan nilai dalam persen (contoh: 33 untuk 33%).</small>
                        </div>

                        <div class="form-group mt-3">
                            <label for="input2df9">Normal</label>
                            <input type="number" name="input2df9" id="input2df9" class="form-control" required>
                            <small class="text-muted">Masukkan nilai dalam persen (contoh: 33 untuk 33%).</small>
                        </div>

                        <div class="form-group mt-3">
                            <label for="input3df9">Low</label>
                            <input type="number" name="input3df9" id="input3df9" class="form-control" required>
