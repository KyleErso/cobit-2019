...
class Df6Controller extends Controller
{
    ...
    {
        return view('df6.design_factor6', compact('id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Menampilkan ukuran array $DF6_SC_BASELINE
    ...
    public function showOutput($id)
    {
        ...
        // ===================================================================
        return view('df6.df6_output', compact('designFactor6', 'designFactorRelativeImportance'));
    }
